...
```bash
cd /app/
git clone https://prgrmz07:3JkTXud1AmGCUCM-4Kgn@gitcode.net/pubx/jetbrains/jetbrains_crack.git
...
2. 正常解压pycharm
3. 修改/app/pycharm-2022.3/bin/pycharm64.vmoptions
>末尾添加以下内容
```text
...
2. 正常解压clion
3. 修改/app/clion-2022.3.3/bin/pycharm64.vmoptions
>末尾添加以下内容
```text
--add-opens=java.base/jdk.internal.org.objectweb.asm=ALL-UNNAMED
--add-opens=java.base/jdk.internal.org.objectweb.asm.tree=ALL-UNNAMED
